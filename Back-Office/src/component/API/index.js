...
const loadDonationData = async (id) => {
  try {
...
const addDonationData = async (donation) => { 
  try {
    const data = await addDonation(donation);
    return data;
  } catch (error) {
    throw error;
  }
...
const updateDonationData = async (donation) => {
  try {
    const data = await updateDonation(donation);
    return data;
  } catch (error) {
    throw error;
  }
